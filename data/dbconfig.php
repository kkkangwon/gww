...
define('G5_MYSQL_USER', 'gww');
define('G5_MYSQL_PASSWORD', 'gwwgww1212');
define('G5_MYSQL_DB', 'gww_db');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'wp_');

define('G5_TOKEN_ENCRYPTION_KEY', '4fcdb5f894aa1051a2e9de80546e6491'); // 토큰 암호화에 사용할 키
...
define('G5_SHOP_TABLE_PREFIX', 'gww_');
