...
?>
<link rel="stylesheet" href="<?php echo $board_skin_url?>/flexslider/css/demo.css" type="text/css" media="screen" />
<link rel="stylesheet" href="<?php echo $board_skin_url?>/flexslider/flexslider.css" type="text/css" media="screen" />
<link rel="stylesheet" href="<?php echo $board_skin_url?>/flexslider_modify.css">
...
<div class="flex_wrap">
<div id="carousel" class="flexslider file_<?php echo  $view['file']['count']?>">
        <ul class="slides">
            <?php
        // 파일 출력
...
<!-- } 게시판 읽기 끝 -->
<script defer src="<?php echo $board_skin_url?>/flexslider/jquery.flexslider.js"></script>
<script>
