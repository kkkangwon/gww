...
<link href="<?=$board_skin_url?>/fotorama/fotorama.css" rel="stylesheet">
           ...
           <div class="row">
              <div class="col-md-5 col-sm-12 col-xs-12">
               <section id="fotorama-wiz">
                    <div class="fotorama" data-navposition="bottom" data-nav="thumbs" data-arrows="true" data-loop="true" data-maxheight="1430">
                    <?php
        // 파일 출력
