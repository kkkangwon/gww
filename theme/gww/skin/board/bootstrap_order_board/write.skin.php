    ...
    <label for="wr_10">개인정보수집이용에 동의합니다.</label>
        ...
        <?php } ?>
            ...
            <div class="box email ">
                ...
                <div class="form phone_wrap">
                    <label for="wr_1" class="sound_only">연락처<strong>필수</strong></label>
                    <input name='hp1' class=' phone' value='<?=$hp1?>' type='text' maxlength='6' onkeydown='onlyNumber(this);' placeholder="010">
                    <input name='hp2' class=' phone required' required value='<?=$hp2?>' type='text' maxlength='4' onkeydown='onlyNumber(this);'>
                    <input name='hp3' class=' phone required' required value='<?=$hp3?>' type='text' maxlength='4' onkeydown='onlyNumber(this);'>
                </div>
        ...
        <div id="autosave_wrapper" class="write_div">
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="form-control form-subject required" size="50" maxlength="255" placeholder="제목">
