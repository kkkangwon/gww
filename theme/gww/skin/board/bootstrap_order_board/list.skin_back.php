...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="bo_fx hidden">
        ...
        <ul class="btn_bo_user">
            <?php if ($rss_href) { ?><li><a href="<?php echo $rss_href ?>" class="btn btn-default">RSS</a></li><?php } ?>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo $list[$i]['href'] ?>">
                    ...
                    <?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">댓글</span><span class="badge"><?php echo $list[$i]['comment_cnt']; ?></span><span class="sound_only">개</span><?php } ?>
                </a>
...
//                if (isset($list[$i]['icon_hot'])) echo $list[$i]['icon_hot'];
    ...
    <div class="bo_fx">
        ...
        <span class="btn-group">
            <input type="submit" name="btn_submit" value="선택삭제" onclick="document.pressed=this.value" class="btn btn-info"></li>
            <input type="submit" name="btn_submit" value="선택복사" onclick="document.pressed=this.value" class="btn btn-info"></li>
            <input type="submit" name="btn_submit" value="선택이동" onclick="document.pressed=this.value" class="btn btn-info"></li>
        </span>
<?php } ?>
        <?php } ?>
        ...
        <ul class="btn_bo_user">
            <?php if ($list_href) { ?><li><a href="<?php echo $list_href ?>"  class="btn-pack white">목록</a></li><?php } ?>
	...
	<div class="container-fluid" style="font-size:12px;">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<div class="navbar-form navbar-left form-group">
				...
				<input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="form-control required" placeholder="검색어(필수)" maxlength="20" style="font-size:12px; text-center">
			</div>
			<div class="navbar-form navbar-left form-group">
