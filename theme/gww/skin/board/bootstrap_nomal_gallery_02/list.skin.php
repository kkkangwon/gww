...
<link rel="stylesheet" href="<?php echo G5_THEME_URL?>/wzd_lib/plugin/magnific-popup/magnific-popup.css">
<!-- Magnific Popup core JS file -->
<script src="<?php echo G5_THEME_URL?>/wzd_lib/plugin/magnific-popup/jquery.magnific-popup.js"></script>
	...
	$('.popup-gallery').magnificPopup({
		...
		image: {
			...
			titleSrc: function(item) {
				return item.el.attr('title') + '<small><?php echo $config['cf_title']; ?></small>';
			}
		}
	});
});
...
<div id="bo_gall" style="width:<?php echo $width; ?>">
 ...
 <!-- 게시판 카테고리 시작 { -->
    ...
    <?php } ?>
                ...
                <div class="review-wrap <?php if(!$is_admin){ ?>popup-gallery<?php } ?>">
                    <div class="row"> 
...
<!--                    <a href="<?php echo $list[$i]['ca_name_href'] ?>" class="bo_cate_link"><?php echo $list[$i]['ca_name'] ?></a>-->
                    <?php } ?>
                        ...
                        <h3><a href="<?php echo $list[$i]['href'] ?>"><?php echo $list[$i]['subject'] ?></a>
                         <?php
