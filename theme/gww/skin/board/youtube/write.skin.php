...
<section id="bo_w">
    ...
    <div class="bo_w_info write_div">
	    ...
	    <?php } ?>
        <label for="wr_10" class="sound_only">유부트주소</label>
	        <input type="text" name="wr_10" value="<?php echo $write['wr_10'] ?>" id="wr_10"  class="frm_input full_input" size="50" placeholder="유튜브 주소 예) https://www.youtube.com/watch?v=9bZkp7q19f0">
	</div>
