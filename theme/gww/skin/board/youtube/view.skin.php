    ...
    <section id="bo_v_atc">
        ...
        <?php 
            ...
            <?php if($v){ ?>
                ...
                <iframe class="embed-responsive-item" src="//www.youtube.com/embed/<?php echo $v; ?>?feature=player_detailpage&vq=hd720" frameborder="0" allowfullscreen></iframe>
            </div>
            <p></p>
         <?php } ?>
        <!-- } 유튜브 동영상 시작 -->
        ...
        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con" class="mt50"><?php echo get_view_thumbnail($view['content']); ?></div>
